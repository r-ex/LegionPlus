...
static std::vector<DXGI_FORMAT> TxtrFormatToDXGI{
	...
	DXGI_FORMAT_R8G8B8A8_UNORM_SRGB,  // _SRGB
...
static std::vector<DXGI_FORMAT> NSwitchTxtrFormatToDXGI{
	  ...
	  DXGI_FORMAT_R8G8_SINT ,
	  DXGI_FORMAT_R8G8_UINT ,
	  DXGI_FORMAT_UNKNOWN, // 0x79
	  DXGI_FORMAT_UNKNOWN, // 0x7A
	  DXGI_FORMAT_UNKNOWN, // 0x7B
	  DXGI_FORMAT_UNKNOWN, // 0x7C
	  DXGI_FORMAT_UNKNOWN, // 0x7D
	  DXGI_FORMAT_UNKNOWN, // 0x7E
	  DXGI_FORMAT_UNKNOWN, // 0x7F
	  DXGI_FORMAT_UNKNOWN, // 0x81
	  DXGI_FORMAT_P208 , // 0x82
	  DXGI_FORMAT_UNKNOWN, // 0x80
	  DXGI_FORMAT_V208 , // 0x83
	  DXGI_FORMAT_V408 , // 0x84
	  DXGI_FORMAT_UNKNOWN, // 0x85
	  DXGI_FORMAT_UNKNOWN, // 0x86
	  DXGI_FORMAT_UNKNOWN, // 0x87
	  DXGI_FORMAT_UNKNOWN, // 0x88
	  DXGI_FORMAT_UNKNOWN, // 0x89
	  DXGI_FORMAT_UNKNOWN, // 0x8A
	  DXGI_FORMAT_UNKNOWN, // 0x8B
	  DXGI_FORMAT_UNKNOWN, // 0x8C
	  DXGI_FORMAT_UNKNOWN, // 0x8D
	  DXGI_FORMAT_UNKNOWN, // 0x8F
	  DXGI_FORMAT_UNKNOWN, // 0x90
	  DXGI_FORMAT_UNKNOWN, // 0x8E
	  DXGI_FORMAT_UNKNOWN, // 0x91
	  DXGI_FORMAT_UNKNOWN, // 0x92
	  DXGI_FORMAT_UNKNOWN, // 0x93
	  DXGI_FORMAT_UNKNOWN, // 0x94
...
/*static std::vector<DXGI_FORMAT> NSwitchTxtrFormatToDXGI{
	DXGI_FORMAT_R8G8B8A8_SNORM,
	DXGI_FORMAT_B8G8R8A8_UNORM,  // _SRGB
	DXGI_FORMAT_B8G8R8A8_UNORM,  // _SRGB
	DXGI_FORMAT_B8G8R8A8_UNORM,  // _SRGB
	DXGI_FORMAT_B8G8R8A8_UNORM,  // _SRGB
